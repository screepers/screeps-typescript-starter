...
export default class SpawnApi {
    ...
    private static generateCreepOptions(
        ...
        switch (role) {
            ...
            case ROLE_ZEALOT:
                return SpawnHelper.generateZealotOptions(roomState);
            case ROLE_MEDIC:
                return SpawnHelper.generateMedicOptions(roomState);
            case ROLE_STALKER:
                return SpawnHelper.generateStalkerOptions(roomState);
            default:
